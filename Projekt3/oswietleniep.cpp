...
void rysowaniePiramidy(){
    ...
    glBegin(GL_QUADS);
		glVertexAttrib3f(GLT_ATTRIBUTE_COLOR, 0.6f, 0.6f, 0.6f);
        glVertex3fv(a);
        glVertex3fv(b);
        glVertex3fv(c);
        glVertex3fv(d);
    ...
    glBegin(GL_TRIANGLES);
		glVertexAttrib3f(GLT_ATTRIBUTE_COLOR, 0.75, 0.25f, 0.5f);
        TriangleFace(e, b, c);
    glEnd();
	
    glBegin(GL_TRIANGLES);
		glVertexAttrib3f(GLT_ATTRIBUTE_COLOR, 0.0f, 0.45f, 0.75f);
        TriangleFace(e, c, d);
    glEnd();
